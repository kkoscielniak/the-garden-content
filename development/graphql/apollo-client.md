...
In [[development/react/_index|React]] we also can use `<ApolloProvider />` and use `useQuery` hook instead of handling everything with promises and [[development/react/prop-drilling]].
