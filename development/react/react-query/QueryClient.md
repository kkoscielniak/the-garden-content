...
- `invalidateQueries([key])` - makes the query/queries with a given key invalid, forcing React Query to fetch that data again. Can be used in [[development/react/react-query/useMutation]] hook -> `onSuccess` method.
