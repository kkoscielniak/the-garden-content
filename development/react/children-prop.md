...
We can see that this syntax is similar to how the [[development/react/render-props]] are used.

---

We can use the `children` prop to avoid [[development/react/prop-drilling]] (we add props to the child component and don't have to pull `truthy` prop in the `<Header />` component implementation.
