...
_Intruder_ is [[cybersecurity/knowledge/tools/burp/|Burp Suite]]'s in-built [[cybersecurity/knowledge/glossary/fuzzing]] tool. It allows us to take a request (usually captured in the [[cybersecurity/knowledge/tools/burp/proxy]] beforehand) and use it as a template to send many more requests with slightly altered values automatically.
...
*Positions* allows us to select an _Attack Type_, as well as configure where in the request template we wish to insert our [[cybersecurity/knowledge/glossary/payload]]s.
