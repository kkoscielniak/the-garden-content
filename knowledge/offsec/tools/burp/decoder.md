...
Decoder also allows us to create [_hashsums_](/knowledge/offsec/glossary/hashing.md) of data, as well as providing a Smart Decode feature which attempts to decode provided data recursively until it is back to being plaintext.
